...
1. 19 % 10 = 9 → remainder after dividing by 10 **(last digit)**

2. 19 // 10 = 1 → quotient after dividing by 10 **(remaining digits)**
...
print(last_digit)
```
### Method 2: Using % and // (for more than 2 digit numbers)

``` python
n = 4123

last_digit = n % 10      # 3
remaining_digit = n // 10    # 4123
